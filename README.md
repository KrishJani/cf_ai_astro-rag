...
>
> During the fast-paced hackathon, my primary contributions were **designing the RAG pipeline, integrating Cloudflare Vectorize and D1, and developing the main API endpoints on Cloudflare Workers**.
>
...
### Database Only (`db-only`)
  ...
  - Returns "NOT\_IN\_DB" if no relevant content found
